...
def show_tags():
    ...
    #embed()
    return "<html><head><link href=\"static/style.css\" rel=\"stylesheet\" type=\"text/css\"></head><body><h1>%s</h1><h1>Hello World!</h1><img src=\"%s\" style=\"width:300px\"><div>%s</div><div>%s</div></body></html>" % (cfg['title'],cfg['awesome_image'],form_html,tags_html)
